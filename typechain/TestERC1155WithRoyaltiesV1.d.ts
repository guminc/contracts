...
interface TestERC1155WithRoyaltiesV1Interface extends ethers.utils.Interface {
  functions: {
...
export class TestERC1155WithRoyaltiesV1 extends BaseContract {
  ...
  interface: TestERC1155WithRoyaltiesV1Interface;
