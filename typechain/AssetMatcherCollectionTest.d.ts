...
interface AssetMatcherCollectionTestInterface extends ethers.utils.Interface {
  functions: {
...
export class AssetMatcherCollectionTest extends BaseContract {
  ...
  interface: AssetMatcherCollectionTestInterface;
