...
interface ExchangeSimpleV21Interface extends ethers.utils.Interface {
  functions: {
...
export class ExchangeSimpleV21 extends BaseContract {
  ...
  interface: ExchangeSimpleV21Interface;
