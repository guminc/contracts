...
interface TestERC721WithRoyaltiesV2Interface extends ethers.utils.Interface {
  functions: {
...
export class TestERC721WithRoyaltiesV2 extends BaseContract {
  ...
  interface: TestERC721WithRoyaltiesV2Interface;
