...
interface SimpleTransferManagerInterface extends ethers.utils.Interface {
  functions: {};
...
export class SimpleTransferManager extends BaseContract {
  ...
  interface: SimpleTransferManagerInterface;
