...
interface ERC721LazyMintTestInterface extends ethers.utils.Interface {
  functions: {
    "approve(address,uint256)": FunctionFragment;
    "balanceOf(address)": FunctionFragment;
    "baseURI()": FunctionFragment;
    "encode((uint256,string,(address,uint96)[],(address,uint96)[],bytes[]))": FunctionFragment;
...
export class ERC721LazyMintTest extends BaseContract {
  ...
  interface: ERC721LazyMintTestInterface;
