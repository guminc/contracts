...
interface TestAssetMatcherInterface extends ethers.utils.Interface {
  functions: {
...
export class TestAssetMatcher extends BaseContract {
  ...
  interface: TestAssetMatcherInterface;
