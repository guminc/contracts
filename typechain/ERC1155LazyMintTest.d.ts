...
interface ERC1155LazyMintTestInterface extends ethers.utils.Interface {
  functions: {
    "balanceOf(address,uint256)": FunctionFragment;
    "balanceOfBatch(address[],uint256[])": FunctionFragment;
    "encode((uint256,string,uint256,(address,uint96)[],(address,uint96)[],bytes[]))": FunctionFragment;
...
export type CreatorsEvent = TypedEvent<
  [
    ...
    tokenId: BigNumber;
    creators: ([string, BigNumber] & { account: string; value: BigNumber })[];
  }
>;

export type SupplyEvent = TypedEvent<
  [BigNumber, BigNumber] & { tokenId: BigNumber; value: BigNumber }
>;
...
export class ERC1155LazyMintTest extends BaseContract {
  ...
  interface: ERC1155LazyMintTestInterface;
