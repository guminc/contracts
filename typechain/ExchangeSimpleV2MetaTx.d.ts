...
interface ExchangeSimpleV2MetaTxInterface extends ethers.utils.Interface {
  functions: {
...
export class ExchangeSimpleV2MetaTx extends BaseContract {
  ...
  interface: ExchangeSimpleV2MetaTxInterface;
