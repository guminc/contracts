...
interface TestERC1155WithRoyaltiesV2Interface extends ethers.utils.Interface {
  functions: {
    ...
    "mint(address,uint256,(address,uint96)[],uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [
      string,
      BigNumberish,
      { account: string; value: BigNumberish }[],
      BigNumberish
    ]
  ): string;
  encodeFunctionData(
...
export class TestERC1155WithRoyaltiesV2 extends BaseContract {
  ...
  interface: TestERC1155WithRoyaltiesV2Interface;
