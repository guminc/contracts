...
interface PunkTransferProxyTestInterface extends ethers.utils.Interface {
  functions: {
...
export class PunkTransferProxyTest extends BaseContract {
  ...
  interface: PunkTransferProxyTestInterface;
